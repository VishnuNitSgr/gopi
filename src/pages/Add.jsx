       ...
       <div className='w-full'>
        ...
        <textarea onChange={(e)=>setDescription(e.target.value)} value={description} className='w-full max-w-[500px] px-3 py-2' type='text' placeholder='Write content here' required/>
         ...
         <div className='flex flex-col sm:flex-row gap-2 w-full sm:gap-8'>
          <div>
            <p  className='mb-2'>Productcategory</p>
          ...
          <div>
            ...
            <select onChange={()=>setSubCategory(e.target.value)} className='w-full px-3 py-2' name="" id="">
          ...
          <button type='submit' className='w-28 my-3 mt-4 bg-slate-600 text-white rounded-md'> Add</button>
    </form>
  );
};
